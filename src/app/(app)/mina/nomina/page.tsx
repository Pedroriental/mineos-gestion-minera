  ...
  try {
    ...
    const [
      ...
      loadNominaRotacionContext(area).catch((err) => {
        console.error('[MinaNominaPage] loadNominaRotacionContext error:', err);
    ...
    console.error('[MinaNominaPage] Server render error:', err);
    return (
      <div className="p-6 max-w-4xl mx-auto space-y-4">
        <div className="rounded-xl border border-red-500/30 bg-red-500/10 p-5 text-red-200">
          <h2 className="text-lg font-bold text-red-300">Error al cargar la nómina de Mina</h2>
