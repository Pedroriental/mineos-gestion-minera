...
const ALL_ROUTES = [
  ...
  { label: 'Nómina',             href: '/admin/nomina',           section: 'Administración', icon: <Users className="w-4 h-4" /> },
  ...
  { label: 'Producción',         href: '/planta/produccion',      section: 'Planta',         icon: <BarChart2 className="w-4 h-4" /> },
  { label: 'Recepción',          href: '/planta/recepcion',       section: 'Planta',         icon: <Package className="w-4 h-4" /> },
  { label: 'Procesamiento',      href: '/planta/procesamiento',   section: 'Planta',         icon: <FlaskConical className="w-4 h-4" /> },
  { label: 'Arenas',             href: '/planta/arenas',          section: 'Planta',         icon: <FlaskConical className="w-4 h-4" /> },
