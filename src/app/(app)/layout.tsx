...
const ALL_ROUTES = [
  ...
  { label: 'Voladuras',          href: '/mina/voladuras',         section: 'Molino',          icon: <Zap className="w-4 h-4" /> },
  { label: 'Quemado de Planchas',href: '/mina/quemado',           section: 'Molino',          icon: <Flame className="w-4 h-4" /> },
  { label: 'Equipos',            href: '/mina/equipos',           section: 'Molino',          icon: <Wrench className="w-4 h-4" /> },
  { label: 'Seguridad',          href: '/mina/seguridad',         section: 'Molino',          icon: <ShieldCheck className="w-4 h-4" /> },
  { label: 'Producción',         href: '/planta/produccion',      section: 'Mina',            icon: <BarChart2 className="w-4 h-4" /> },
  { label: 'Recepción',          href: '/planta/recepcion',       section: 'Mina',            icon: <Package className="w-4 h-4" /> },
  { label: 'Procesamiento',      href: '/planta/procesamiento',   section: 'Mina',            icon: <FlaskConical className="w-4 h-4" /> },
  { label: 'Arenas',             href: '/planta/arenas',          section: 'Mina',            icon: <FlaskConical className="w-4 h-4" /> },
