      ...
      <div className="flex items-center justify-between gap-3 flex-wrap">
        <div>
          <h1 className="text-white/90 font-bold tracking-tight text-2xl flex items-center gap-3">
            <Factory className="w-6 h-6 text-amber-400" /> {PAGE_TITLE}
          </h1>
                    ...
                    {todasSemanas.map((sem) => (
                      <tr key={sem.id} className="border-b border-zinc-800/50 hover:bg-zinc-900/30 transition-colors">
                        ...
                        <td className="px-4 py-3 text-right">
                          <button onClick={() => handleRevertirSemana(sem)} disabled={!canEdit || revertiendoId === sem.id} className="flex items-center gap-1.5 text-xs text-red-400/60 hover:text-red-400 transition-colors disabled:opacity-40 ml-auto border border-red-500/20 hover:border-red-400/40 bg-red-500/5 rounded-lg px-2.5 py-1.5">
